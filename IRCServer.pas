...
{function FlipAddress(addr: in_addr): in_addr;
var
  TempAddr: in_addr;
begin
  TempAddr.s_un_b.s_b1 := addr.s_un_b.s_b4;
  TempAddr.s_un_b.s_b2 := addr.s_un_b.s_b3;
  TempAddr.s_un_b.s_b3 := addr.s_un_b.s_b2;
  TempAddr.s_un_b.s_b4 := addr.s_un_b.s_b1;
  Result := TempAddr;
end;  }
